...
//
//  Wszystkie #Preview macros dla SummaryView — non-success states (failed/saving/loading) +
//  loaded scenarios (short/long/Monday AMRAP+Strength/CrossFit FOR TIME/CrossFit AMRAP+EMOM).
