//
//  WeightTrendFeature+Action.swift
//  MyFitnessJournal
//
...
extension WeightTrendFeature {
    ...
    enum Action: ViewAction {
        ...
        enum Internal {
            /// Triggers fetching weight data from HealthKit.
            case fetchData

            /// Receives the result of the weight data fetch.
            case dataResponse(Result<[WeightDataPoint], Error>)
        ...
        enum View {
            ...
            case dataPointSelected(WeightDataPoint?)
        }
    }
}
