...
//                                    .font(.caption)
//                                    .foregroundStyle(.secondary)
//                                Text(String(format: "%d min", Int(workout.duration) / 60))
//                                    .font(.title2)
//                                    .bold()
//                            }
//                            .padding(2)
...
//                                Text(workout.statistics(for: HKQuantityType(.heartRate))?.averageQuantity()?.doubleValue(for: .count().unitDivided(by: .minute())).formatted(.number.precision(.fractionLength(1))) ?? "—")
//                                    .font(.title2)
//                                    .bold()
//                            }
//                            .padding(2)
...
//                                    .font(.caption)
//                                    .foregroundStyle(.secondary)
//                                Text(workout.statistics(for: HKQuantityType(.heartRate))?.maximumQuantity()?.doubleValue(for: .count().unitDivided(by: .minute())).formatted(.number.precision(.fractionLength(1))) ?? "—")
//                                    .font(.title2)
//                                    .bold()
//                            }
//                            .padding(2)
