...
final class DefaultTrainingManager: NSObject, TrainingManager, @unchecked Sendable {
    ...
    func getWorkoutMetrics() -> SharedModels.WorkoutMetrics {
        WorkoutMetrics(averageHeartRate: 0, heartRate: 0, activeEnergy: 0)
    }
    ...
    var workoutMetricsStream: AsyncStream<SharedModels.WorkoutMetrics> {
...
//
//@MainActor
//public final class DefaultTrainingManager: NSObject, TrainingManager {
//
//    // MARK: - HealthKit Configuration
//
//    let healthStore: HKHealthStore
